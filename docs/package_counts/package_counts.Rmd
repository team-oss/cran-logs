...
fp <- here::here('./output/package_counts/package_counts_diagram.html')
htmlwidgets::saveWidget(diagram, file = fp)
```

<iframe src='./output/package_counts/package_counts_diagram.html'>